...
TEST_F( TestCgdaRecognitionLib, TestCgdaRecognitionLib_DTW_compare)
{
    ...
    generalizedRandom.push_back({6.25});
    generalizedRandom.push_back({12.5});
    generalizedRandom.push_back({18.75});
    generalizedRandom.push_back({25});
    generalizedRandom.push_back({31.25});
    generalizedRandom.push_back({37.5});
    generalizedRandom.push_back({43.75});
    generalizedRandom.push_back({50});
    generalizedRandom.push_back({56.25});
    generalizedRandom.push_back({62.5});
    generalizedRandom.push_back({68.75});
    generalizedRandom.push_back({75});
    generalizedRandom.push_back({81.25});
    generalizedRandom.push_back({87.5});
    generalizedRandom.push_back({93.75});
