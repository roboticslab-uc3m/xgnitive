...
#ifndef CGDA_CONST_WAX_IET_H_
#define CGDA_CONST_WAX_IET_H_
...
class CgdaConstrainedWaxFitnessFunction : public EvaluateOp {
...
typedef boost::shared_ptr<CgdaConstrainedWaxFitnessFunction> CgdaConstrainedWaxFitnessFunctionP;
