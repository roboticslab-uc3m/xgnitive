...
Low1=plt.plotfile('data-20.txt', cols=(0, 1), delimiter=' ', 
                     names=('Time interval (Adimensional)', 'Number of evaluations'), marker='s', label='20 deg/iter')
...
Low3=plt.plotfile('data-80.txt', cols=(0, 1), delimiter=' ', 
                     names=('Time interval (Adimensional)', 'Number of evaluations'), marker='o', newfig=False, label='80 deg/iter')

Mid=plt.plotfile('data-100.txt', cols=(0, 1), delimiter=' ', 
                     names=('Time interval (Adimensional)', 'Number of evaluations'), marker='^', newfig=False, label='100 deg/iter')

High=plt.plotfile('data-120.txt', cols=(0, 1), delimiter=' ', 
                     names=('Time interval (Adimensional)', 'Number of evaluations'), marker='x', newfig=False, label='120 deg/iter')
